...
const Categorey = () => {
    ...
    return (
        <div>
            ...
            <Tabs>
                <TabList>
                    <Tab><button className="" type="button" onClick={() => setcategorey(items)}>all</button></Tab>
                  
                    {catitems.map(cate => <Tab key={cate._id} onClick={() => catfilter(cate.categorey)}>{cate.categorey
                    }</Tab>
                    )}
